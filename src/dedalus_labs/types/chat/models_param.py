...
__all__ = [
    "ModelsParam",
    "ModelsParamItem",
    "ModelsParamItemDedalusModel",
    "ModelsParamItemDedalusModelSettings",
    "ModelsParamItemDedalusModelSettingsReasoning",
    "ModelsParamItemDedalusModelSettingsToolChoice",
    "ModelsParamItemDedalusModelSettingsToolChoiceMCPToolChoice",
]


class ModelsParamItemDedalusModelSettingsReasoningTyped(TypedDict, total=False):
...
ModelsParamItemDedalusModelSettingsReasoning: TypeAlias = Union[
    ModelsParamItemDedalusModelSettingsReasoningTyped, Dict[str, object]
]


class ModelsParamItemDedalusModelSettingsToolChoiceMCPToolChoice(TypedDict, total=False):
    name: Required[str]

    server_label: Required[str]


ModelsParamItemDedalusModelSettingsToolChoice: TypeAlias = Union[
...
class ModelsParamItemDedalusModelSettings(TypedDict, total=False):
    ...
    reasoning: Optional[ModelsParamItemDedalusModelSettingsReasoning]
    ...
    tool_choice: Optional[ModelsParamItemDedalusModelSettingsToolChoice]
...
class ModelsParamItemDedalusModel(TypedDict, total=False):
    model: Required[str]
    """
    ...
    settings: Optional[ModelsParamItemDedalusModelSettings]
    """
...
ModelsParamItem: TypeAlias = Union[ModelID, ModelsParamItemDedalusModel]

ModelsParam: TypeAlias = List[ModelsParamItem]
